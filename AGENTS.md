...
Use this pack to help an AI coding agent work with `pydantic/pydantic-ai` safely and verifiably.

## When To Use

- The user wants `load Pydantic AI agent runtime context, tool-call boundaries, state handoff checks, tracing notes, and eval guidance into your AI host before building agent apps`.
