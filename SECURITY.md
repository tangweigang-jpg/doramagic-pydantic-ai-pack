...
This repository is an independent AI context resource pack for pydantic/pydantic-ai. It is not Pydantic's official security contact.
...
Upstream product vulnerabilities should be reported to pydantic/pydantic-ai's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
